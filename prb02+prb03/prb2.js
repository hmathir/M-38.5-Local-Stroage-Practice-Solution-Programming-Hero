...
const isTrue = confirm('Wanna see your broeser Location?');
if(isTrue){
    console.log(location.href);
}else{
const userInput = prompt('Put A Number');
const addedNumber = parseFloat(userInput) + 250;
alert(`Final Number is: ${addedNumber}`);
}